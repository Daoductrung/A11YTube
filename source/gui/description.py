...
class DescriptionDialog(wx.Dialog):
	def __init__(self, parent, content):
		...
		txtExport = wx.Button(panel, -1, _("Export to text file (txt)..."), name="export")
		htmlExport = wx.Button(panel, -1, _("Export to web page (html)..."), name="export")
...
"""
		...
		description = "<br>\n".join(description) # Fixed invalid escape sequence
